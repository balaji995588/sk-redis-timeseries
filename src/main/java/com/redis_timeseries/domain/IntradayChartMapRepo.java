//package com.sharekhan.mobservice.domain;
//
...
//
//import com.sharekhan.feedServer.classes.GraphSummerizedTicks;
//import com.sharekhan.mobservice.utility.ChartPeriod;
//
...
//	}
//	
//	/*public List<GraphSummerizedTicks> getChartbyInterval(int interval,long startindex, long endindex) {
//		
...
//	}	*/
//	
///*public List<GraphSummerizedTicks> getTickData(int Scripcode,long startindex, long endindex) {
//		
//	
//	lst = zeroTickIntraday.graphticks.get(scripCode).stream().filter(cData -> cData.getLtt() > start)
